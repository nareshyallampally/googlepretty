	...
	copy: {
	  main: {
	    files: [
	      ...
	      {expand:true,cwd:'node_modules/google-code-prettify/src/',src:["**/*.css"],dest:'dist/css/vendor/google-code-prettify/1.0.5/'},
	  	  {expand:true,cwd:'node_modules/google-code-prettify/src/',src:["**/*.js"],dest:'dist/scripts/vendor/google-code-prettify/1.0.5/'},
	  	  {expand:true,cwd:'node_modules/google-code-prettify/styles/',src:["**/*.css"],dest:'dist/css/vendor/google-code-prettify/1.0.5/theme/'},
	      ]
	  	}
	}
});
